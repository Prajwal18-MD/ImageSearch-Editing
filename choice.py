...
q = 'Punith Rajkumar'  # Example search query
...
if response.status_code == 200:
    ...
    # Download and save the best-matching image
image_filename = "best_matching_image.jpg"  # Specify the desired filename
urllib.request.urlretrieve(best_image_url, image_filename)

print("Best Image URL:", best_image_url)
print("Best Image saved as:", image_filename)
